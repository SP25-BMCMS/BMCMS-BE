...
export class LocationDetailController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Location detail created successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  async createLocationDetail(
    @Body() createLocationDetailDto: CreateLocationDetailDto,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Location detail updated successfully',
  })
  @ApiResponse({ status: 404, description: 'Location detail not found' })
  @ApiResponse({ status: 400, description: 'Bad request' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Location detail deleted successfully',
  })
  @ApiResponse({ status: 404, description: 'Location detail not found' })
